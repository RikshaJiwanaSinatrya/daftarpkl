...
<div class="card">
    ...
    <form action="{{ route('siswa.update', $siswa->id) }}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label>Jurusan</label>
                <input type="text" name="jurusan" value="{{ old('jurusan', $siswa->jurusan) }}" required>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="nama_perusahaan" value="{{ old('nama_perusahaan', $siswa->nama_perusahaan) }}" required>
                @error('nama_perusahaan') <div class="error">{{ $message }}</div> @enderror
            </div>
            <div class="form-group">
                <label>Bidang PKL</label>
                <input type="text" name="bidang_pkl" value="{{ old('bidang_pkl', $siswa->bidang_pkl) }}" required>
